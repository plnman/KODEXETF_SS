...
- [ ] Tab 2: 백테스팅 결과 — 누적수익률 362.84% (5종목 기준)
- [ ] Tab 3: 알고리즘 무결성 진단 — TICKER_PARAMS 22종목 전부 표시
...
| 유니버스 | 22종목 (국내 10 + 글로벌 12) |
| 백테스트 기간 | 2019-01-02 ~ 2026-04-03 (1781 rows) |
| 초기 자본 | 5,000만원 |
